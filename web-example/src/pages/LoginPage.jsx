  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Securely access your financial dashboard" />
      </Helmet>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-card shadow-lg p-8 rounded-xl">
            ...
            <div className="mb-8 text-center">
              <h1 className="mb-2 font-bold text-foreground text-2xl">Welcome Back</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="remember" className="text-secondary text-xs cursor-pointer">
          ...
          <div className="space-y-2 mt-8 text-center">
            ...
            <div className="flex justify-center items-center space-x-4 text-secondary text-xs">
