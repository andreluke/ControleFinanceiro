...
const DropdownMenuContent = React.forwardRef(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 bg-popover shadow-md p-1 border rounded-md min-w-[8rem] overflow-x-hidden overflow-y-auto text-popover-foreground max-h-[var(--radix-dropdown-menu-content-available-height)]",
